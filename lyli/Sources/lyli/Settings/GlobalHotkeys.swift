...
extension KeyboardShortcuts.Name {
    ...
    static let allLyliNames: [Self] = [
        .toggleOverlay, .toggleLockPosition, .openLyricsManagerHotkey,
        .openSettingsHotkey, .playPauseHotkey,
        ...
        .toggleMenuBarLyricsHotkey, .lyricsOffsetResetHotkey,
    ]
...
enum GlobalHotkeys {
    static func registerAll() {
        ...
        #if DEBUG
        for name in KeyboardShortcuts.Name.allLyliNames {
