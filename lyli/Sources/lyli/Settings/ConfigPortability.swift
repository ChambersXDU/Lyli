...
private let logger = Logger(subsystem: "com.chambersxdu.lyli", category: "config-portability")
...
enum ConfigPortability {
    private static let configDir = LyliPaths.configDir

    static var configFolderURL: URL { configDir }
    private static let configURL = configDir.appendingPathComponent("config.json")
    private static let featuresURL = configDir.appendingPathComponent("lyli-features.json")
    ...
    static func suggestedFilename() -> String {
        ...
        return "Lyli-Config-\(formatter.string(from: Date())).json"
    }
