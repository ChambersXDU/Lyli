...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    @objc private func handleGetURLEvent(_ event: NSAppleEventDescriptor, withReplyEvent replyEvent: NSAppleEventDescriptor) {
        guard let urlString = event.paramDescriptor(forKeyword: AEKeyword(keyDirectObject))?.stringValue,
              let url = URL(string: urlString), url.scheme == LyliIdentity.urlScheme else {
            return
        }
    ...
    private let reopenLogger = Logger(subsystem: "com.chambersxdu.lyli", category: "reopen")
    ...
    private static let scrollForwardLog = Logger(
        subsystem: "com.chambersxdu.lyli", category: "scroll-forward")
