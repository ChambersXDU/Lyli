...
final class MenuBarScrollingLabel: NSView {
    private static let scrollAnimationKey = "lyli.marquee"
    private static let fillAnimationKey = "lyli.karaoke-fill"
    private static let basePositionAnimationKey = "lyli.karaoke-base-pos"
    private static let baseBoundsAnimationKey = "lyli.karaoke-base-bounds"
    private static let iconFillAnimationKey = "lyli.progress-fill"
    private static let iconBasePositionAnimationKey = "lyli.progress-base-pos"
    private static let iconBaseBoundsAnimationKey = "lyli.progress-base-bounds"
